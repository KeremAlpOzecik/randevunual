...
export default function RandevuPage({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-lg bg-slate-50 px-4 py-8 text-slate-900 sm:px-6 sm:py-12">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 text-slate-900 shadow-sm sm:rounded-3xl sm:p-8">
