...
export function getStorefrontClasses(useDark: boolean): StorefrontThemeClasses {
  if (useDark) {
    return {
      ...
      bookingSub: "text-slate-300",
      bookingPanel: "border-slate-600 bg-slate-900/90",
      input: "border-slate-600 bg-slate-900 text-slate-50 placeholder:text-slate-500",
      dayDefault: "border-slate-600 bg-slate-900 text-slate-100 hover:border-slate-400",
      dayDisabled: "border-slate-800 bg-slate-950 text-slate-600 opacity-50",
      slotDefault: "border-slate-600 bg-slate-900 text-slate-100 hover:border-slate-400",
      footerLink: "text-slate-400 hover:text-slate-200",
      loadingCard: "border-slate-700 bg-slate-900 text-slate-200",
    };
  }
